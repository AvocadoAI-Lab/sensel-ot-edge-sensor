"""Enforce OT protection-center managed whitelist before packet-sensor detection (G6).

Mirrors edge-agent ``managed_listfile_enforcement`` — reads the shared
``managed-listfiles.json`` volume artifact.
"""
