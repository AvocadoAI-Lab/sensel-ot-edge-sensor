...
> 上方播放器未顯示時，點上圖或 [▶ 1080p MP4](docs/video/sensel-walkthrough-1080.mp4) 觀看；文字版見 [docs/walkthrough.md](docs/walkthrough.md)，製作方式見 [docs/video/](docs/video/README.md)（用 HeyGen HyperFrames 直出 MP4）。
